...
// is present in the array. Return the index of the first occurrence of x in the array, 
...
let array = [ 1,5,6,7,88,9,5,6];
let get_first_digit = 88 ;
let found = false ;

for( let i = 0 ; i < array.length ; i ++ )  {

    if ( array[i] == get_first_digit ) {
        console.log(i);
        found = true;
        break;
    }
...
console.log(
    " Hello world  !! Here we go my friend "
);